...
\frameT{Procedural Generation} {
	\begin{itemize}
		\item The dungeon itself is built using room layouts
		\begin{figure}
			\centering
			\includegraphics[scale=.08]{dungeon_room.png}
		\end{figure}
		\medskip
		\item The room layouts are procedurally connected to provide a fluid start to finish dungeon
		\begin{figure}
			\centering
...
\frameT{Future Work} {
	\begin{itemize}
		\item Creating more room layouts and floor
		\bigskip
