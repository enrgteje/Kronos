...
\frameT{Terms} {
	\begin{itemize}
		...
		\begin{figure}
			\centering
			\includegraphics[scale=.075]{vr.jpg}
		\end{figure}
	\end{itemize}
}
...
\frameT{Procedural Generation} {
	\begin{itemize}
		\item The dungeon itself is built using rooms
		\bigskip
		\item Plugin uses a depth-first search algorithm
		\bigskip
		\item Plugin connects rooms to each other dynamically
		\bigskip
		\item Rooms are procedurally connected to provide a fluid start to finish dungeon
	\end{itemize}
}
...
\frameT{Procedural Generation Continued} {
	\begin{figure}
		...
		\caption{Top-down view of a single room}
	\end{figure}
	\medskip
	\begin{figure}
		\centering
		\includegraphics[scale=.075]{dungeon.png}
...
\frameT{Gameplay} {
	\begin{itemize}
		...
		\bigskip
		\item Environment and enemies will reflect the era of the level
		\bigskip
		\item Consumable items that affect player stats
	\end{itemize}
}
...
\frameT{Trials and Tribulations} {
	\begin{figure}[ht]
		\begin{minipage}[b]{0.3\linewidth}
    	\centering
    			\includegraphics[scale=0.13]{sprite.png}
    	\end{minipage}
    	\hspace{0.5cm}
    	\begin{minipage}[b]{0.5\linewidth}
      		\centering
...
\frameT{Future Work} {
	\begin{itemize}
		...
		\bigskip
		\item Further refinement of AI behavior
		\bigskip
		\item More enemies and bosses
		\bigskip
		\item Have a save system
	\end{itemize}
}
